...
public final class FolderDao_Impl implements FolderDao {
  ...
  public FolderDao_Impl(@NonNull final RoomDatabase __db) {
    ...
    this.__insertionAdapterOfFolderEntity = new EntityInsertionAdapter<FolderEntity>(__db) {
      ...
      protected String createQuery() {
        return "INSERT OR REPLACE INTO `folders` (`id`,`name`,`parentId`,`color`,`icon`,`sortOrder`,`createdAt`) VALUES (nullif(?, 0),?,?,?,?,?,?)";
      }
    ...
    this.__updateAdapterOfFolderEntity = new EntityDeletionOrUpdateAdapter<FolderEntity>(__db) {
      ...
      @NonNull
      protected String createQuery() {
        return "UPDATE OR ABORT `folders` SET `id` = ?,`name` = ?,`parentId` = ?,`color` = ?,`icon` = ?,`sortOrder` = ?,`createdAt` = ? WHERE `id` = ?";
      }
  ...
  public Flow<List<FolderEntity>> getAllFolders() {
    final String _sql = "SELECT * FROM folders ORDER BY sortOrder ASC";
      ...
      public List<FolderEntity> call() throws Exception {
        ...
        try {
          ...
          while (_cursor.moveToNext()) {
            ...
            _item = new FolderEntity(_tmpId,_tmpName,_tmpParentId,_tmpColor,_tmpIcon,_tmpSortOrder,_tmpCreatedAt);
            _result.add(_item);
          }
          return _result;
        } finally {
  ...
  public Flow<List<FolderEntity>> getRootFolders() {
    final String _sql = "SELECT * FROM folders WHERE parentId IS NULL ORDER BY sortOrder ASC";
    final RoomSQLiteQuery _statement = RoomSQLiteQuery.acquire(_sql, 0);
    return CoroutinesRoom.createFlow(__db, false, new String[] {"folders"}, new Callable<List<FolderEntity>>() {
      @Override
      @NonNull
  ...
  public Flow<List<FolderEntity>> getChildFolders(final long parentId) {
    final String _sql = "SELECT * FROM folders WHERE parentId = ? ORDER BY sortOrder ASC";
      ...
      public FolderEntity call() throws Exception {
        ...
        try {
          ...
          if (_cursor.moveToFirst()) {
            ...
            final long _tmpCreatedAt;
            _tmpCreatedAt = _cursor.getLong(_cursorIndexOfCreatedAt);
            _result = new FolderEntity(_tmpId,_tmpName,_tmpParentId,_tmpColor,_tmpIcon,_tmpSortOrder,_tmpCreatedAt);
          } else {
            _result = null;
          }
          return _result;
